...
printf("You had %d left.", (14 - counter));
	...
	int main()
{
	...
	printf("TA : Michael Irizarry, Tues 5pm\n");
	printf("Jan 25, 2017\n\n");
	...
	while (1)
	{
		...
		//counts how many moves player made and use it in the table at the end
		movesCount++;
		if (movesCount > 14) {
			break;
		}
		...
		jumpedPeg = (sourcePeg + destinationPeg) / 2;
