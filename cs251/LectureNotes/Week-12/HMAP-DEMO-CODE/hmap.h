...
*/
extern void *hmap_get(HMAP * map, char *key);
...
*/
extern void * hmap_set(HMAP * map, char *key, void *val);
...
*/
extern void *hmap_remove(HMAP * map, char *key); 
...
*
*/
extern void ** hmap_extract_values(HMAP * map); 
