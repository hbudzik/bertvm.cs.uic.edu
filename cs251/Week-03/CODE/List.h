...
class List
{
  ...
  public:
     ...
     *
     * The list is to be populated with only two distinct values
     * passed in as parameters del and other.  The first parameter
     * del is the item which when deleted should result in quadratic
     * runtime.
     */
    static List<T> * sra_bad_case(const T &del, const T &other, int n) {
